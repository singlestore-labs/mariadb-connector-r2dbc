...
public class PrepareResultSetTest extends BaseConnectionTest {
  ...
  void parameterVerification() {
    ...
    assertThrows(
        ...
        "No encoder for class com.singlestore.r2dbc.integration.PrepareResultSetTest (parameter at"
            + " index 0) ");
    assertThrows(
        IndexOutOfBoundsException.class,
    ...
    assertThrows(
        ...
        "No encoder for class com.singlestore.r2dbc.integration.PrepareResultSetTest");
